...
Any previous versions of the plugin in the plugins folder (e.g. TritechAcquisitionV1_24.jar)
should be deleted. 
...
Limitations
The software currently does NOT support dual sonars. It will acquire data from >1
sonar, but the devices will not be correctly synchronised, so will interfere with
one another. 

Files
/plugins/TritechAcquisitionV1_25.jar is a pure Java PAMGuard plugin that
