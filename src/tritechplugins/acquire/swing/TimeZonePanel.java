...
public class TimeZonePanel {
	...
	private TimeZoneComboBox offlineTimeZone;
...
//	private ArrayList<TimeZone> timeZones;
	...
	public TimeZonePanel() {
		...
		c.gridy++;
		c.gridwidth = 3;
		mainPanel.add(offlineTimeZone = new TimeZoneComboBox(), c);
//		fillTimeZones();
...
//			}
//		}
		offlineTimeZone.setTimeZone(id);
	}
//	
	public String getTimeZoneId() {
		TimeZone tz =  offlineTimeZone.getTimeZone();
		if (tz == null) {
			return null;
		}
		return tz.getID();
